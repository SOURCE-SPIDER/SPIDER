...
return send(msg.chat_id,msg.id,Reply_Status(Info_User,'*عـزيـزي الـمـطـور فـيـنوم تم حظره من الـصانـع بنجاح .*').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(NASA..'BaN:In:Tuasl',Info_User)  
return send(msg.chat_id,msg.id,Reply_Status(Info_User,'*عـزيـزي الـمـطـور فـيـنوم تم الـغاء حظره من الـصانـع بنجاح .*').Reply,"md",true)  
end 
end
end
...
send(msg.chat_id,msg.id,"• تـم حفـظ البيانـات وتشغـيل بوتـك بنجاح ‼️\n\n• يوزر البوت @["..botuser.."] \n• الـمـطـوࢪ "..sudo_state.."\n\n🔰 [ٍَOٖٓSٖٓAٖٓMٖٓAٰٖٓ َِVٖٓEٰٖNَِOٖٓMٰٖٓ](t.me/WWWL5)\n🔰 [َِٖٓSَِOَٖٓUٰٖRَِCٖٓEٰٖٓ َِVٖٓEٖٓNَِOٖٓMٰٖٓ ](t.me/MRv7x)","md",true)
return false 
end
