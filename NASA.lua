...
LuaTele.sendText(Sudo_Id,0,"● اصدار سورس SEVEN \n● الاصدار » G.4 GOLD\n√")
dofile('NASA.lua')  
return false 
end
...
local news =[[
⨳ أهلا بك في صانع بوتات حمايه SEVEN 
]]
reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
...
{
{text = '`˚₊· ͟͟͞͞➳❥❬ 𝐎𝐒𝐀𝐌𝐀 ❭•', url = 't.me/WWWL5'}, 
},
{
...
{{text = ' اخفاء الامر ', data =msg.sender_id.user_id..'/delAmr'},},}}
 send(msg.chat_id,msg.id,"https://t.me/MAXosos","html",false, false, false, false, reply_markup)
end
