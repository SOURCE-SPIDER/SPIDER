...
LuaTele = luatele.set_config{api_id=10022445,api_hash='e914dd8baba8b1cb250b6066cd24d445',session_name=NASA,token=Token}
function var(value)
...
return send(msg.chat_id,msg.id,Reply_Status(Info_User,'*عـزيـزي الـمـطـور أسـامة تم حظره من الـصانـع بنجاح .*').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(NASA..'BaN:In:Tuasl',Info_User)  
return send(msg.chat_id,msg.id,Reply_Status(Info_User,'*عـزيـزي الـمـطـور أسـامة تم الـغاء حظره من الـصانـع بنجاح .*').Reply,"md",true)  
end 
end
end
...
{
{text = 'حظر عام ❌',type = 'text'},{text = 'الغاء العام ⭕️',type = 'text'},
},
{
{text = 'قسم الاذاعه ✳️',type = 'text'},{text = 'قسم المصنع ❇️',type = 'text'},
},
{
{text = 'قسم التفعيل 🈯️',type = 'text'},
},
{
...
{
{text = 'الاصدار ‌⚙️⁩',type = 'text'},{text = 'تحديث السورس 📥',type = 'text'},
},
{
...
send(msg.chat_id,msg.id,"*● اهلاً بك عـزيـري الـمـطور أسـامة* \n","md",true, false, false, true, reply_markup)
return false 
end
if text == "قسم الاذاعه ✳️" then 
reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
{text = 'إذاعه للمجموعات 🔉',type = 'text'},{text = 'إذاعه للمشتركين 🔈',type = 'text'},
},
{
{text = 'اذاعه بالبوت 🔉',type = 'text'},{text = 'اذاعه بالتوجيه 🔈',type = 'text'},
},
{
{text = 'اذاعه تثبيت 🔉',type = 'text'},{text = 'اذاعه بالتوجيه 🔈',type = 'text'},
},
{
{text = '• الغاء الامر •',type = 'text'},
},
...
if text == "قسم المصنع ❇️" then 
reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
{text = 'المشتركين 🦸‍♂',type = 'text'},{text = 'جلب نسخه 🦸‍♂',type = 'text'},
},
{
...
if text == "قسم التفعيل 🈯️" then 
reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
{text = 'تشغيل بوت ✅',type = 'text'},{text = 'إيقاف بوت ❎',type = 'text'},
},
{
{text = 'تشغيل الصانع ✅',type = 'text'},{text = 'تعطيل الصانع ❎',type = 'text'},
},
{
{text = 'تفعيل التواصل ✅',type = 'text'},{text = 'تعطيل التواصل ❎',type = 'text'},
},
{
{text = 'تفعيل الإجباري ✅',type = 'text'},{text = 'تعطيل الإجباري ❎',type = 'text'},
},
{
{text = 'القائمه الرئيسيه ⏺',type = 'text'},
},
...
if text == "المشتركين 🦸‍♂" or text == "المشتركين" then
...
send(msg.chat_id,msg.id,"*قم بإرسال الشخص لحظره ..*","md",true)
end
...
local news =[[
⨳ أهلا بك في صانع بوتات حمايه سبايدر
]]
reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
...
data = {
{
{text = '𓏺 ᥉᥆υᖇᥴᥱ ᥉ρᎥժᥱᖇ . 🕷 ˼', url = 't.me/EE_20'}, 
},
{
{text = '𒅒• !! 𝐎𝐒𝐀𝐌𝐀 ᵛ͢ᵎᵖ 𒅒', url = 't.me/WWWL5'}, 
},
{
{text = '𝗗𝗲𝘃𝗲𝗟𝗼𝗣𝗲𝗥𝘀', url = 't.me/SOURCE_Dev'}, 
},
}
}
send(-1001690426912,0,"*⨳ تم تنصيب بوت علي سورس سبايدر\n┄──━━━ 𝗦𝗣𝗜𝗗𝗘𝗥 ━━━──┄\n*⨳ يوزر البوت:- @["..botuser.."] *\n*⨳ يوزر المطور :- "..sudo_state.."*\n*⨳ اصبح عدد البوتات علي الصانع الآن : `"..#allb.."` بوت*\n*","md",false, false, false, false, reply_markup)
send(msg.chat_id,msg.id,"● سيتم تشغيل بوتك بعد ثوانى\n\n● يوزر البوت @["..botuser.."] \n● الـمـطـوࢪ "..sudo_state.."\n\n [★⃝➼𝕆𝕊𝔸𝕄𝔸 . 🕷 ˼](t.me/WWWL5)\n [𓏺 ᥉᥆υᖇᥴᥱ ᥉ρᎥժᥱᖇ . 🕷 ˼](t.me/EE_20)","md",true)
return false 
end
...
data = {
{
{text = ' اضغط هنا للحصول علي التوكن', url = 't.me/BotFather'}, 
},
{
...
{{text = ' اخفاء الامر ', data =msg.sender_id.user_id..'/delAmr'},},}}
 send(msg.chat_id,msg.id,"https://t.me/SPidER1x","html",false, false, false, false, reply_markup)
end
