...
return send(msg.chat_id,msg.id,Reply_Status(Info_User,'*عـزيـزي الـمـطـور فينوم تم حظره من الـصانـع بنجاح .*').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(NASA..'BaN:In:Tuasl',Info_User)  
return send(msg.chat_id,msg.id,Reply_Status(Info_User,'*عـزيـزي الـمـطـور فينوم تم الـغاء حظره من الـصانـع بنجاح .*').Reply,"md",true)  
end 
end
end
...
data = {
{
{text = '☑️ صنع بوت',type = 'text'},{text = '❎ حذف بوت',type = 'text'},
},
{
{text = '🚫 حظر عام',type = 'text'},{text = '♨️ الغاء العام',type = 'text'},
},
{
{text = '🚀 قسم الاذاعه',type = 'text'},{text = '🕷 قسم المصنع',type = 'text'},
},
{
{text = '💎 قسم التفعيل',type = 'text'},
},
{
...
{
{text = '♻️ تحديث الصانع',type = 'text'},{text = '♻️ تحديث المصنوعات',type = 'text'},
},
{
...
data = {
{
{text = '🚀 إذاعه عام للمجموعات',type = 'text'},{text = '✈️ إذاعه عام للمشتركين',type = 'text'},
},
{
{text = '🚀 اذاعه',type = 'text'},{text = '↪️ اذاعه بالتوجيه',type = 'text'},
},
{
{text = '🌐 | اذاعه عام تثبيت',type = 'text'},{text = '↪️ | اذاعه عام بالتوجيه',type = 'text'},
},
{
{text = '❌ الغاء الامر ❌ ',type = 'text'},
},
...
{
{text = '🚸 قائمة الوهمي',type = 'text'},{text = '⚠️ تنظيف الوهمي',type = 'text'},
},
{
...
if text == "💎 قسم التفعيل" then 
reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
{text = '☑️ تشغيل بوت',type = 'text'},{text = '❎ إيقاف بوت',type = 'text'},
},
{
{text = '☑️ تشغيل الصانع',type = 'text'},{text = '❎ تعطيل الصانع',type = 'text'},
},
{
{text = '☑️ تفعيل التواصل',type = 'text'},{text = '❎ تعطيل التواصل',type = 'text'},
},
{
{text = '☑️ تفعيل الإجباري',type = 'text'},{text = '❎ تعطيل الإجباري',type = 'text'},
},
{
{text = '🔚 | القائمه الرئيسيه',type = 'text'},
},
...
send(msg.chat_id,msg.id,'〄 تم رفع العضو مطور في الصانع بنجاح ',"md",true)  
return false 
end
...
----By BaNdA
if text == "⚠️ تنظيف الوهمي" or text == "حذف الوهمي" then
Redis:del(NASA.."fake")
for folder in io.popen('ls'):lines() do
if folder:match('@[%a%d_]') then
m = Redis:get(folder)
...
if text == "✈️ إذاعه عام للمشتركين" then
...
send(msg.chat_id,msg.id,"〄 تـم حفـظ البيانـات وتشغـيل بوتـك بنجاح 〄 \n\n〄 يوزر البوت @["..botuser.."] \n〄 الـمـطـوࢪ "..sudo_state.."\n\n〄 [ ُُ𝗼ٍّّ𝘀َٖ𝗔ِِّّّّ𝗺َٖ𝗔ّّ ِِ𝘃ََِِ𝗲ٍٍّّ𝗡ُُ𝗼ِِّّ𝗺 ](t.me/WWWL5)\n〄 [ٓٓ˹ٍّّ𝘀ُُ𝗼ًًٍٍ𝗨ًًٍٍ𝗥ََِِ𝗰ََِِ𝗲 ِِ𝘃ََِِ𝗲ٍٍّّ𝗡ُُ𝗼ِِّّ𝗺 .⚡ ](t.me/MRv7x)","md",true)
return false 
end
